 ...
 */
@Component({
  selector: 'app-image-viewer-original',
  templateUrl: './image-viewer-original.component.html',
  styleUrls: ['./image-viewer-original.component.scss']
})
export class ImageViewerOriginalComponent implements OnChanges, OnInit, AfterViewInit {
